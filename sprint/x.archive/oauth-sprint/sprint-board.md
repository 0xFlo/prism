...
## Success Criteria
- [x] Dashboard requires authentication (no anonymous access)
- [x] Account 1 continues using service account (unchanged)
- [x] Account 2 can connect via OAuth to i@alba.cc
- [x] Tokens refresh automatically
- [x] Complete test coverage for dual-mode authentication
- [x] Data remains isolated between accounts
...
4. **Scope Contract**: All functions must accept current_scope (enforced via Scope helpers)
